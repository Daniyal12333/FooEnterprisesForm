...
namespace DataLayer
{
    internal static class Universal
    {
        ...
        internal static string GetConnectionString()
        {
            ...
            return "Data Source=DANIYAL-PC;Initial Catalog=FooEnterprises;Integrated Security=True";
        }
...
namespace BusinessLayer
{
    ...
    public static class ExecuteNonQuery
    {
        ...
        {
            return DataLayer.Universal.ExecuteNonQueryFromSqlStatement(sql, sqlParams);
        }
    }
    ...
    public static class LoadData
    {
        ...
        public static List<T> FromSqlStatement<T>(string sql, params object[] sqlParams)
            where T : class, new()
        {
            DataTable dt = DataLayer.Universal.GetDataFromSqlStatement(sql, sqlParams);
