...
{
    [Serializable]
    public partial class Customer : DataLayer.Customer
    {
    ...
    public class Customers : List<Customer>
    {
        ...
        public void GetByStoredProcedure(string procedureName)
        {
            ...
            DataTable dt = DataLayer.Customer.GetByStoredProcedure(connectString, procedureName, null);
            if (dt != null)
            {
                Load(dt.Rows);
            }
        ...
        public void GetBySqlStatement(string sql, params object[] sqlParams)
        {
            ...
            DataTable dt = DataLayer.Customer.GetBySqlStatement(connectString, sql, sqlParams);
            if (dt != null)
            {
                Load(dt.Rows);
            }
        ...
        private void GetAll(bool useStoredProcedures)
        {
            ...
            DataTable dt = DataLayer.Customer.GetAll(connectString, useStoredProcedures);
            if (dt != null)
            {
                Load(dt.Rows);
            }
        ...
        {
            List<DataLayer.Customer.SerializableCustomer> zc;
            ...
            using (System.IO.MemoryStream ms = new System.IO.MemoryStream(data))
            {
                using (Newtonsoft.Json.Bson.BsonReader reader = new Newtonsoft.Json.Bson.BsonReader(ms))
                {
                    ...
                    zc = serializer.Deserialize<List<DataLayer.Customer.SerializableCustomer>>(reader);
                }
            }

            foreach (DataLayer.Customer.SerializableCustomer z in zc)
            {
        ...
        {
            System.Xml.Serialization.XmlSerializer xType = new System.Xml.Serialization.XmlSerializer(typeof(List<DataLayer.Customer.SerializableCustomer>));
            List<DataLayer.Customer.SerializableCustomer> zc;
            Customers tmp = new Customers();

            using (System.IO.StringReader sr = new System.IO.StringReader(xml))
            {
                zc = (List<DataLayer.Customer.SerializableCustomer>)xType.Deserialize(sr);
            }
        ...
        {
            List<DataLayer.Customer.SerializableCustomer> zs = Newtonsoft.Json.JsonConvert.DeserializeObject<List<DataLayer.Customer.SerializableCustomer>>(json);
            Customers tmp = new Customers();

            foreach (DataLayer.Customer.SerializableCustomer z in zs)
            {
                tmp.Add(Customer.FromJson(Newtonsoft.Json.JsonConvert.SerializeObject(z)));
            }
